...
- `integracion_ademy_promociones_institucion`: mapeo manual `promocion_id -> institucion` para completar centro cliente cuando Ademy no envia nombre en acreditados.
...
- Convencion integracion Ademy:
  - `candidatos_formaciones.institucion` guarda el nombre del centro/empresa cliente que contrato la capacitacion (incluyendo sucursal cuando aplique).
