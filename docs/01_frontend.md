...
- Mockups post-login: `/app/candidate/vacantes`, `/app/candidate/postulaciones`, `/app/candidate/perfil` y `/app/company`.
...
- Compatibilidad: `/perfil/datos-personales` apunta a la misma vista de datos basicos.
