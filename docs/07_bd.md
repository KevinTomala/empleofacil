...
- `vacantes_publicadas`: vacantes creadas por empresa.
  - columnas clave: `id`, `empresa_id`, `publicado_por`, `titulo`, `area`, `provincia`, `ciudad`, `modalidad`, `tipo_contrato`, `descripcion`, `requisitos`, `estado`, `fecha_publicacion`, `fecha_cierre`, `activo`, timestamps, `deleted_at`.
  - estados: `borrador|activa|pausada|cerrada`.
  - indices: `idx_vacantes_empresa_estado`, `idx_vacantes_estado_publicacion`, `idx_vacantes_busqueda`.
- `postulaciones`: relacion candidato-vacante.
  - columnas clave: `id`, `vacante_id`, `candidato_id`, `empresa_id`, `estado_proceso`, `fecha_postulacion`, `ultima_actividad`, `origen`, `activo`, timestamps, `deleted_at`.
  - `estado_proceso` inicia en `nuevo`.
  - unicidad: `uq_postulacion_vacante_candidato (vacante_id, candidato_id)`.
  - indices: `idx_postulaciones_empresa_estado`, `idx_postulaciones_candidato_fecha`, `idx_postulaciones_vacante_fecha`.
